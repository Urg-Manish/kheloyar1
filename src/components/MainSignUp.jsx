    ...
    <ChakraProvider>
      <Box bg="#1D212E">
        <div className="d-flex bg-dark">
          ...
          {/* ----------------------form -------------------------- */}
          <Box w="40%">
            <Box color="white" mt={{ base: "25px", md: "50px", lg: "50px" }}>
              <Box>
                <Link to="/">
                  <Image
                    h="100px"
              ...
              <Box
                ...
                w="90%"
                m="auto"
                border={"2px solid #CBA902"}
                borderRadius={"20px"}
                mt="20px"
              >
                <Text fontSize={"35px"}>
                  Now <span style={{ color: "rgb(255,212,2)" }}>Create</span> an
                  account easily on
                  <span style={{ color: "rgb(255,212,2)" }}>WhatsApp!</span>
                </Text>
                <Flex
                  bg="#2AB63F"
                  w="80%"
                ...
                >
                  <Image
                    ...
                    h="60px"
                    mt="-5px"
                    src="https://dqqdyv927mezc.cloudfront.net/kheloyar/clientweb/images/WA.svg"
                  />
                  <Text fontSize={"16px"} fontWeight={"650"} mt="10px" ml="30%">
                    Need ID
                  </Text>
                </Flex>
              </Box>
              ...
              <form onSubmit={handleSubmit}>
                <VStack spacing={5} align={"start"} p="20px">
                  ...
                  <Input
                    ...
                    leftElement={
                      <InputLeftElement
                        children={<Icon as={FaUser} boxSize={5} />}
                      />
                    }
                  />
                  ...
                  <Input
                    ...
                    leftElement={
                      <InputLeftElement
                        children={<Icon as={FaLock} boxSize={5} />}
                      />
                    }
                  />
                  ...
                  <Input
                    ...
                    leftElement={
                      <InputLeftElement
                        children={<Icon as={FaPhone} boxSize={5} />}
                      />
                    }
                  />
              ...
              <Text pb="40px">
                ...
                <span style={{ color: "skyblue" }}>Login</span>
              </Text>
            </Box>
          </Box>
        </div>
